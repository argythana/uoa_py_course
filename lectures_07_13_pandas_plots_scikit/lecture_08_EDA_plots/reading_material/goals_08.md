...
- [x] Auto-EDA notebook uses heart disease dataset with ydata-profiling, Sweetviz, Autoviz, and PyGWalker.
...
- Use auto-EDA tools (ydata-profiling, Sweetviz, Autoviz, PyGWalker, Vizro, to generate reports automatically.
...
- `lec_08f_auto_EDA.ipynb` — Auto-EDA tools: ydata-profiling, Sweetviz, Autoviz, PyGWalker.
