# Lecture 06: Define Functions

## Learning Goals

- Define custom functions using `def`, docstrings, indented body, and `return` statement.
- Understand the difference between parameters (names in definition) and arguments (values in call).
